...
echo '<a class="dropdown-item" href="index.php">Home Page</a>';
echo '<a class="dropdown-item" href="details.php">View Messages</a>';
echo '</div>';
echo '</li>';
echo '';
echo '</ul>';
...
foreach($data as $key => $data1){
    ...
    echo '<tr>';
    echo '<td>'; echo $i; '</td>';
    echo '<td>'; echo $data1['Name']; echo'</td>';
    echo '<td>'; echo $data1['StudentID']; echo'</td>';
    echo '<td>'; echo $data1['Class']; echo'</td>';
    echo '<td>'; echo $data1['Time']; echo'</td>';
    echo '<td>'; echo 'Attendance Taken'; echo'</td>';
